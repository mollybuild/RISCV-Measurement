...
由于D1上的glibc版本是2.31，而最新工具链源码的glibc是2.33，因此要先编译glibc版本低于2.31的工具链，可以参考 https://zhuanlan.zhihu.com/p/386123758 其中的2.2部分。
...
```shell
$ sudo ln -s /usr/bin/size /home/cxo/temp/riscv/riscv64-unknown-linux-gnu-size 
```
